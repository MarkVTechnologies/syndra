      ...
      <Container className="relative">
        <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-display text-lg font-bold text-[var(--estate-cream-50)]">SAN</p>
          ...
          <nav className="flex flex-wrap gap-x-6 gap-y-2 text-sm">
            ...
            <a href="mailto:support@san.com" className="transition-colors hover:text-[var(--estate-cream-50)]">Contact</a>
          </nav>
        </div>
        <p className="mt-8 border-t border-[rgba(253,251,212,0.1)] pt-6 text-xs text-[var(--estate-sand-300)]/60">
          ...
          principal. This is not investment advice. &copy; {new Date().getFullYear()} SAN.
        </p>
      </Container>
    </footer>
  );
